...
interface AllAnnouncementsGridClientProps {
  announcements: Announcement[];
}

export default function AllAnnouncementsGridClient({
  announcements,
}: AllAnnouncementsGridClientProps) {
  ...
  const renderPageNumbers = () => {
    ...
    if (lastPage - firstPage < maxVisiblePages - 1) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <p className="text-muted-foreground">
            Showing {startIndex + 1}-{Math.min(endIndex, announcements.length)}{" "}
